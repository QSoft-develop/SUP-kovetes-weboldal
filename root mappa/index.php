...
function get_ver_info($code) {
    ...
    return array(
        ...
        qsGetFileSize(__DIR__.'/../kov/FileS/'.$GLOBALS['modules'][$code]['file']) // fájlméret
    );
}
?>
...
<main>
    ...
    <div class="grid">
        ...
        <div class="tile" style="--tile-color:<?php echo $info['color-modal']; ?>" data-name="<?php echo $info['name']; ?>" data-version="<?php echo $v; ?>" data-date="<?php echo $d; ?>" data-size="<?php echo $s; ?>" data-file="<?php echo $info['file']; ?>" data-icon="kepek/<?php echo $info['icon']; ?>" data-color="<?php echo $info['color-tile']; ?>" data-href="../kov/FileS/<?php echo $info['file']; ?>">
...
<footer>
    ...
    <span class="footer-links"><a id="foweb" href="https://www.sup.hu">Fő weboldal</a> | <a href="https://www.facebook.com/sup.hu">Facebook</a></span>
</footer>
</body>
</html>
